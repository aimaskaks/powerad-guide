  ...
  "recommendedParties": [
    {
      ...
      "reason": "このパーティが【${targetJob}×${targetAttr}属性】の冒険者育成に最適な理由。得意訓練のシナジー・必殺技/ASの配置・ステータス効率を200字程度で説明。スキルの説明は必ず【ジョブ×属性別 取得可能スキル対応表】に記載されたもらえるスキルのみ記載し、キャラ固有のスキルは絶対に記載しない"
    }
  ],
  "wantedCharacters": [
  ...
  "recommendedParties": [
    {
      ...
      "members": ["キャラ名1", "キャラ名2", "キャラ名3", "キャラ名4", "キャラ名5", "キャラ名6"],
      "trainingCombo": "得意訓練の組み合わせ説明",
      "reason": "このパーティを推奨する具体的な理由。得意訓練のシナジー・必殺技/ASの配置・ステータス効率を200字程度で説明。スキルの説明は必ず【ジョブ×属性別 取得可能スキル対応表】に記載されたもらえるスキルのみ記載し、キャラ固有のスキルは絶対に記載しない"
    }
  ],
  "wantedCharacters": [
