...
条件：
- recommendedPartiesは「育成するキャラのジョブと属性」が異なる3パーティを提案する
- titleは必ず「【ジョブ名×属性名】」の形式にする（例：【剣士×火属性】、【魔法使い×水属性】）
- titleはそのパーティで効率よく育てられるキャラのジョブと属性を示す
- 各パーティは必ずマリセアを含める（所持している場合）
- メンバーは5人（マリセア含む）
- 得意訓練の組み合わせとスペシャルタッグ効率を重視する
- reasonには得意訓練の組み合わせによる経験値効率の説明を必ず含める
